...
console.log(getImageAndName("bulbasaur"))
...
async function getImageAndName() {
    try {
       let img =  getImageAndName("bulbasaur")
       let pokemonName = getImageAndName("bulbasaur")
...
async function getRandomCharacterInfo(num) { 
    try {
        // Realizar la solicitud a la API
        let response = await fetch(
           `https://rickandmortyapi.com/api/character/${num}`
...
console.log(getRandomCharacterInfo(5));